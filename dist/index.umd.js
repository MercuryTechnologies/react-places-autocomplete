...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SuggestionItem = __webpack_require__(41);
	
	var _SuggestionItem2 = _interopRequireDefault(_SuggestionItem);
	
	var _defaultStyles = __webpack_require__(42);
	      ...
	      return _react2.default.createElement(
	        ...
	        this.shouldRenderDropdown() && _react2.default.createElement(
	          ...
	          autocompleteItems.map(function (p, idx) {
	            /* eslint-disable indent */
	            var style = p.active ? _this4.inlineStyleFor('autocompleteItem', 'autocompleteItemActive') : _this4.inlineStyleFor('autocompleteItem');
	            var className = p.active ? _this4.classNameFor('autocompleteItem', 'autocompleteItemActive') : _this4.classNameFor('autocompleteItem');
	            /* eslint-enable indent */
	            return _react2.default.createElement(
	              'div',
	              {
	...
	PlacesAutocomplete.defaultProps = {
	  ...
	  classNames: {},
	  renderSuggestion: _SuggestionItem2.default,
	  styles: {},
	  options: {},
	  debounce: 200,
